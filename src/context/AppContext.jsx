...
export function AppProvider({ children }) {
  ...
  useEffect(() => {
    ...
    const fetchActivities = async () => {
      try {
        const res = await fetch('https://script.google.com/macros/s/AKfycbyXw94Hkemv8knVvSR6Uq0t8hH6V5z5QikP6u1Ms63RBsyZIB_Ax2mKbKz5JRra8sQT/exec?action=get_activities')
  ...
  const handlePunchIn = () => {
    ...
    const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbyXw94Hkemv8knVvSR6Uq0t8hH6V5z5QikP6u1Ms63RBsyZIB_Ax2mKbKz5JRra8sQT/exec';
    fetch(SCRIPT_URL, {
    ...
    const DAILY_SHEET_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycby8deKwI-aIXXpAErmg27C5QJMQ4lDDm_GAU-cE85HOmuEe9vU0NgLO7Zr13oinv_tr2Q/exec';
  ...
  const handlePunchOut = () => {
    ...
    if (prevEmail) {
      const DAILY_SHEET_URL = 'https://script.google.com/macros/s/AKfycby8deKwI-aIXXpAErmg27C5QJMQ4lDDm_GAU-cE85HOmuEe9vU0NgLO7Zr13oinv_tr2Q/exec';
  ...
  const markChatAsRead = useCallback((chatId, messagesList) => {
    ...
    if (!sessionStorage.getItem(key)) {
      ...
      fetch('https://script.google.com/macros/s/AKfycbyXw94Hkemv8knVvSR6Uq0t8hH6V5z5QikP6u1Ms63RBsyZIB_Ax2mKbKz5JRra8sQT/exec', {
        method: 'POST',
        headers: { 'Content-Type': 'text/plain;charset=utf-8' },
  ...
  const fetchMessages = useCallback(async () => {
    try {
      const url = 'https://script.google.com/macros/s/AKfycbyXw94Hkemv8knVvSR6Uq0t8hH6V5z5QikP6u1Ms63RBsyZIB_Ax2mKbKz5JRra8sQT/exec'
  ...
  const fetchSyncedTasks = async () => {
    ...
    try {
      const url = `https://script.google.com/macros/s/AKfycbyXw94Hkemv8knVvSR6Uq0t8hH6V5z5QikP6u1Ms63RBsyZIB_Ax2mKbKz5JRra8sQT/exec?action=get_tasks&t=${Date.now()}`
      const res = await fetch(url)
  ...
  const fetchTeam = async () => {
    ...
    try {
      const url = `https://script.google.com/macros/s/AKfycbyXw94Hkemv8knVvSR6Uq0t8hH6V5z5QikP6u1Ms63RBsyZIB_Ax2mKbKz5JRra8sQT/exec?action=get_team&t=${Date.now()}`
      const res = await fetch(url)
  ...
  const fetchClients = async () => {
    try {
      const url = `https://script.google.com/macros/s/AKfycbyXw94Hkemv8knVvSR6Uq0t8hH6V5z5QikP6u1Ms63RBsyZIB_Ax2mKbKz5JRra8sQT/exec?action=get_clients&t=${Date.now()}`
      const res = await fetch(url)
  ...
  const fetchPayments = async () => {
    try {
      const url = `https://script.google.com/macros/s/AKfycbyXw94Hkemv8knVvSR6Uq0t8hH6V5z5QikP6u1Ms63RBsyZIB_Ax2mKbKz5JRra8sQT/exec?action=get_payments&t=${Date.now()}`
      const res = await fetch(url)
      if (res.ok) {
        const text = await res.text()
        try {
  ...
  const fetchActivities = async () => {
    try {
      const url = `https://script.google.com/macros/s/AKfycbyXw94Hkemv8knVvSR6Uq0t8hH6V5z5QikP6u1Ms63RBsyZIB_Ax2mKbKz5JRra8sQT/exec?action=get_activities&t=${Date.now()}`
      const res = await fetch(url)
      if (res.ok) {
        const text = await res.text()
        try {
