...
export function AppProvider({ children }) {
  ...
  useEffect(() => {
    ...
    const fetchActivities = async () => {
      try {
        const res = await fetch('https://script.google.com/macros/s/AKfycbyLuyADlfr28CFJBtINrN_ymA9khRD3WuOZ9aOsgHJwO00uwK4wam2ajBu9MJex3Zwy/exec?action=get_activities')
  ...
  const handlePunchIn = () => {
    ...
    const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbyLuyADlfr28CFJBtINrN_ymA9khRD3WuOZ9aOsgHJwO00uwK4wam2ajBu9MJex3Zwy/exec';
    fetch(SCRIPT_URL, {
    ...
    const DAILY_SHEET_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbzqTkpeb9iGDnOclILC_KPBgjNTZhiw43_TuZMW4lgwcV77nyHRVO0YIpB05ZVKo75CCQ/exec';
  ...
  const handlePunchOut = () => {
    ...
    if (prevEmail) {
      const DAILY_SHEET_URL = 'https://script.google.com/macros/s/AKfycbzqTkpeb9iGDnOclILC_KPBgjNTZhiw43_TuZMW4lgwcV77nyHRVO0YIpB05ZVKo75CCQ/exec';
  ...
  const markChatAsRead = useCallback((chatId, messagesList) => {
    ...
    if (!sessionStorage.getItem(key)) {
      ...
      fetch('https://script.google.com/macros/s/AKfycbyLuyADlfr28CFJBtINrN_ymA9khRD3WuOZ9aOsgHJwO00uwK4wam2ajBu9MJex3Zwy/exec', {
        method: 'POST',
        headers: { 'Content-Type': 'text/plain;charset=utf-8' },
  ...
  const fetchMessages = useCallback(async () => {
    try {
      const url = 'https://script.google.com/macros/s/AKfycbyLuyADlfr28CFJBtINrN_ymA9khRD3WuOZ9aOsgHJwO00uwK4wam2ajBu9MJex3Zwy/exec'
  ...
  const fetchSyncedTasks = async () => {
    ...
    try {
      const url = `https://script.google.com/macros/s/AKfycbyLuyADlfr28CFJBtINrN_ymA9khRD3WuOZ9aOsgHJwO00uwK4wam2ajBu9MJex3Zwy/exec?action=get_tasks&t=${Date.now()}`
      const res = await fetch(url)
  ...
  const fetchTeam = async () => {
    ...
    try {
      const url = `https://script.google.com/macros/s/AKfycbyLuyADlfr28CFJBtINrN_ymA9khRD3WuOZ9aOsgHJwO00uwK4wam2ajBu9MJex3Zwy/exec?action=get_team&t=${Date.now()}`
      const res = await fetch(url)
  ...
  const fetchClients = async () => {
    try {
      const url = `https://script.google.com/macros/s/AKfycbyLuyADlfr28CFJBtINrN_ymA9khRD3WuOZ9aOsgHJwO00uwK4wam2ajBu9MJex3Zwy/exec?action=get_clients&t=${Date.now()}`
      const res = await fetch(url)
  ...
  const fetchPayments = async () => {
    try {
      const url = `https://script.google.com/macros/s/AKfycbyLuyADlfr28CFJBtINrN_ymA9khRD3WuOZ9aOsgHJwO00uwK4wam2ajBu9MJex3Zwy/exec?action=get_payments&t=${Date.now()}`
      const res = await fetch(url)
      if (res.ok) {
        const text = await res.text()
        try {
  ...
  const fetchActivities = async () => {
    try {
      const url = `https://script.google.com/macros/s/AKfycbyLuyADlfr28CFJBtINrN_ymA9khRD3WuOZ9aOsgHJwO00uwK4wam2ajBu9MJex3Zwy/exec?action=get_activities&t=${Date.now()}`
      const res = await fetch(url)
      if (res.ok) {
        const text = await res.text()
        try {
