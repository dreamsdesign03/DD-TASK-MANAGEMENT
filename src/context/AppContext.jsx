...
export function AppProvider({ children }) {
  ...
  useEffect(() => {
    ...
    const fetchActivities = async () => {
      try {
        const res = await fetch('https://script.google.com/macros/s/AKfycbx4vMrgNO6V-IdElYDYXgWe1iwOZf33iMP6PXqaMuf9ZgdIykWzTbMDuneDtCLerutV/exec?action=get_activities')
  ...
  const handlePunchIn = () => {
    ...
    const DAILY_SHEET_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbxSlYsXw5YniJnx4GwHTsDojWKmkc3OMAdq_H_PRQxzzimgjZUCdl9_mhRlBMast-MUqQ/exec';
  ...
  const handlePunchOut = () => {
    ...
    if (prevEmail) {
      const DAILY_SHEET_URL = 'https://script.google.com/macros/s/AKfycbxSlYsXw5YniJnx4GwHTsDojWKmkc3OMAdq_H_PRQxzzimgjZUCdl9_mhRlBMast-MUqQ/exec';
  ...
  const markChatAsRead = useCallback((chatId, messagesList) => {
    ...
    if (!sessionStorage.getItem(key)) {
      ...
      fetch('https://script.google.com/macros/s/AKfycbx4vMrgNO6V-IdElYDYXgWe1iwOZf33iMP6PXqaMuf9ZgdIykWzTbMDuneDtCLerutV/exec', {
        method: 'POST',
        headers: { 'Content-Type': 'text/plain;charset=utf-8' },
  ...
  const fetchMessages = useCallback(async () => {
    try {
      const url = 'https://script.google.com/macros/s/AKfycbx4vMrgNO6V-IdElYDYXgWe1iwOZf33iMP6PXqaMuf9ZgdIykWzTbMDuneDtCLerutV/exec'
  ...
  const fetchSyncedTasks = async () => {
    ...
    try {
      const url = `https://script.google.com/macros/s/AKfycbx4vMrgNO6V-IdElYDYXgWe1iwOZf33iMP6PXqaMuf9ZgdIykWzTbMDuneDtCLerutV/exec?action=get_tasks&t=${Date.now()}`
      const res = await fetch(url)
  ...
  const fetchTeam = async () => {
    ...
    try {
      const url = `https://script.google.com/macros/s/AKfycbx4vMrgNO6V-IdElYDYXgWe1iwOZf33iMP6PXqaMuf9ZgdIykWzTbMDuneDtCLerutV/exec?action=get_team&t=${Date.now()}`
      const res = await fetch(url)
  ...
  const fetchClients = async () => {
    try {
      const url = `https://script.google.com/macros/s/AKfycbx4vMrgNO6V-IdElYDYXgWe1iwOZf33iMP6PXqaMuf9ZgdIykWzTbMDuneDtCLerutV/exec?action=get_clients&t=${Date.now()}`
      const res = await fetch(url)
  ...
  const fetchPayments = async () => {
    try {
      const url = `https://script.google.com/macros/s/AKfycbx4vMrgNO6V-IdElYDYXgWe1iwOZf33iMP6PXqaMuf9ZgdIykWzTbMDuneDtCLerutV/exec?action=get_payments&t=${Date.now()}`
      const res = await fetch(url)
      if (res.ok) {
        const text = await res.text()
        try {
  ...
  const fetchActivities = async () => {
    try {
      const url = `https://script.google.com/macros/s/AKfycbx4vMrgNO6V-IdElYDYXgWe1iwOZf33iMP6PXqaMuf9ZgdIykWzTbMDuneDtCLerutV/exec?action=get_activities&t=${Date.now()}`
      const res = await fetch(url)
      if (res.ok) {
        const text = await res.text()
        try {
