...
export default function ProjectOverviewPage() {
  ...
  useEffect(() => {
    ...
    const url = `https://script.google.com/macros/s/AKfycbx4vMrgNO6V-IdElYDYXgWe1iwOZf33iMP6PXqaMuf9ZgdIykWzTbMDuneDtCLerutV/exec?action=get_project_files&projectName=${encodeURIComponent(projectName)}&t=${Date.now()}`
    fetch(url)
      .then(res => res.json())
      .then(data => {
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      ...
      const res = await fetch('https://script.google.com/macros/s/AKfycbx4vMrgNO6V-IdElYDYXgWe1iwOZf33iMP6PXqaMuf9ZgdIykWzTbMDuneDtCLerutV/exec', {
        method: 'POST',
